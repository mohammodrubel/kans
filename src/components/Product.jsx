...
//   const { currentLang } = useLanguage(); // ✅ get current language
...
//             {getItemName(product)} {/* ✅ Show localized name */}
//           </h3>
...
//                 </span> */}
//                 {/* <span className="text-green-600 font-medium">
//                   {(Number(product.discounted_price.USD)).toFixed(2)}
//                 </span> */}
//                 <span className="text-green-600 font-medium">
...
//         getItemName={getItemName} // ✅ Pass to modal too
//       />
//     </>
//   );
// };
